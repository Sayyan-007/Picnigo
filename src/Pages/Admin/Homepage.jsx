...
console.log("Admin ID:",id);
  ...
  return (
    <div className="container-fluid" style={{ backgroundColor: "#1E1E2F" }}>
      ...
      : 
      <div className="row vh-100 text-light justify-content-center align-items-center text-center">
        <div className="col-lg-6">
          <h1>Login the Admin Page</h1>
          <button className="login-btn p-2 fw-bold px-5"><Link className="nav-link" to={'adminlogin'}>Login</Link></button>
        </div>
      </div>
    }
    </div>
