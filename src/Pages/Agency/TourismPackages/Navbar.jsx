...
import { logooutAgency } from '../../../Redux/agencySlice';
import { Pencil, LogOut, User, Mail } from 'lucide-react';
                        ...
                        {id ?
                            <ul className="navbar-nav mx-uto gap-lg-4">
                                <li className='navbar-nav d-flex flex-column'>
                                    <div className='fw-light'><User /> {Agency_Name}</div>
                                ...
                                <li className='nav-item'>
                                    <Link to={'/agency/update'}><button className="login-btn px-3 fw-medium p-2"><Pencil />Edit Profile</button></Link>
                                </li>
                            </ul> :
