...
const BookNow = () => {
    ...
    useEffect(() => {
        const fetchPackages = async () => {
            try {
                const response = await Axios.get("user/travelpackages/display");
                ...
                {data
                    ...
                    .map((packageData) => (
                        <div className="col-lg-6 text-center" key={packageData._id}>
                            ...
                            <h4 className="fw-lighter">Package Name: {packageData.Destination_Name}</h4>
                            <h4 className="fw-lighter">Agency Name: {packageData.Agency_id}</h4>
                            <h4 className="fw-lighter">Agency Name: {packageData.Agency_name}</h4>
                            <h4 className="fw-lighter">Category: {packageData.Category}</h4>
                            ...
                            <Elements stripe={stripePromise}>
                                <PaymentForm
                                    ...
                                    package_name={packageData.Destination_Name}
                                    host_id={packageData.Agency_id}
                                    host_name={packageData.Agency_name}
                                    host_type="Agency"
