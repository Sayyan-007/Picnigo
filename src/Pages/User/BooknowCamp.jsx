...
const BookNowCamp = () => {
    ...
    useEffect(() => {
        const fetchPackages = async () => {
            try {
                const response = await Axios.get("user/camppackages/display");
                ...
                {data
                    ...
                    .map((packageData) => (
                        <div className="col-lg-6 text-center" key={packageData._id}>
                            ...
                            <h4 className="fw-lighter">Camp ID: {packageData._id}</h4>
                            <h4 className="fw-lighter">Camp Name: {packageData.campName}</h4>
                            <h4 className="fw-lighter">type: {packageData.type}</h4>
                            ...
                            <Elements stripe={stripePromise}>
                                <PaymentForm
                                    ...
                                    package_name={packageData.campName}

                                    host_id={packageData.organization_id}
                                    host_name={packageData.organization_name}
                                    host_type="Camp"
