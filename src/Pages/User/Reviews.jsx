                ...
                <div className="row text-center g-4">
                    <div className="col-lg-3 col-md-6 d-flex justify-content-center" >
                        <div className="card border-2 p-4 align-items-center reviewborder"  style={{backgroundColor:"#f7f7f7"}}>
                            <img className="mw-100 w-50 mb-3 text-canter reviewimg" src="happyemj.jpg" alt=""  />
                    ...
                    <div className="col-lg-3 col-md-6 d-flex justify-content-center">
                        <div className="card border-2 p-4 align-items-center reviewborder"  style={{backgroundColor:"#f7f7f7"}}>
                            <img className="mw-100 w-50 mb-3 text-canter reviewimg" src="hotelemj.jpg" alt=""  />
                    ...
                    <div className="col-lg-3 col-md-6 d-flex justify-content-center">
                        <div className="card border-2 p-4 align-items-center reviewborder"  style={{backgroundColor:"#f7f7f7"}}>
                            <img className="mw-100 w-50 mb-3 text-canter reviewimg" src="locationemj.jpg" alt=""  />
                    ...
                    <div className="col-lg-3 col-md-6 d-flex justify-content-center">
                        <div className="card border-2 p-4  align-items-center reviewborder"  style={{backgroundColor:"#f7f7f7"}} >
                            <img className="mw-100 w-50 mb-3 text-canter" src="evevntemj.jpg" alt=""  />
                                <h1 className="fw-light">50+</h1>
