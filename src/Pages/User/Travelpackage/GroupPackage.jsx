        ...
        <div >
            ...
            <Hero/>
                <div className="container-fluid mt-5">
                    <div className="row">
                        <div className="">
                            <p className="text-dark fw-bold fs-3">Solo Packages</p>
                        </div>
                    </div>
                    <div className="row justify-content-center">
                            ...
                            <div key={data._id} className=" col-lg-3 col-md-4 shadow mx-lg-4 mt-3 p-3 bg-transparent card">
                                <div  style={{ width: "", overflow: "hidden" }} className="w-100">
                                   <img className="rounded-4 w-100" src={data.Destination_Image} style={{ objectFit: "cover" ,height:"350px",width:"100%"}} alt="" />
                                </div>
                                <div className="d-flex flex-column text-dark p-3">
                                    <div className="fw-bold fs-6">
                                        <p className="m-1">Name : <span className="fw-light">{data.Destination_Name}</span></p>
                                        <p className="m-1">Agency : <span className="fw-light">{data.Agency_name}</span></p>
                                        <p className="m-1">Climate : <span className="fw-light">{data.Climate}</span></p>
                                    ...
                                    <div>
                                        {userId ?
                                         <div>
                                            <Link to={`/booknowagency/${data._id}`}><button className="opp-btn p-2 fw-bold px-3">Book Now</button></Link>
                                         </div>
                                        : 
                                        <div>
